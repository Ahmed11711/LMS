export const fields = [
  { key: "course_id", label: "Course Id", required: 1,
     placeholder: "Enter Course Id", type: "number", isString: false },
  ...
  { key: "order", label: "Order", required: 1, placeholder: "Enter Order", type: "text", isString: false }
];