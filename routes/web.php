...
Route::get('kashier/webhook/academy/{id}', [WebHookSubscribeController::class, 'handle']);
Route::post('kashier/webhook/academy/{id}', [WebHookSubscribeController::class, 'handle']);
